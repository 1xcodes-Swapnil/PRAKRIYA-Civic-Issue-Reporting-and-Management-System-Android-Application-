...
public class AdminProfileActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        loadUserProfile();
        // Load notices when the screen becomes visible
        loadMyNotices();
    }
    ...
    // --- METHOD TO LOAD ADMIN'S POSTED NOTICES ---
    private void loadMyNotices() {
        if (myNoticesContainer == null) {
            Log.e(TAG, "myNoticesContainer is null. Check your activity_admin_profile.xml layout file.");
            return;
        }
        myNoticesContainer.removeAllViews(); // Clear old views
        ...
        db.collection("notices")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        Toast.makeText(AdminProfileActivity.this, "Could not load notices.", Toast.LENGTH_SHORT).show();
                    }
                });
    }

    // --- METHOD TO CREATE AND ADD A NOTICE CARD TO THE VIEW (WITH CUSTOM DIALOG) ---
    private void addNoticeCardToView(Notice notice, String noticeId) {
        ...
        deleteButton.setOnClickListener(v -> {
            ...
            // Get buttons and text views from the custom layout
            ...
            btnDelete.setOnClickListener(view -> {
                ...
                db.collection("notices").document(noticeId).delete()
                        .addOnSuccessListener(aVoid -> {
                            Toast.makeText(AdminProfileActivity.this, "Notice deleted", Toast.LENGTH_SHORT).show();
                            loadMyNotices(); // Refresh the list
                        })
                        .addOnFailureListener(e -> Toast.makeText(AdminProfileActivity.this, "Failed to delete notice.", Toast.LENGTH_SHORT).show());
            });
    ...
    // --- All other standard profile methods below ---
    ...
    private void showEditProfileDialog() {
        ...
        dialog.setContentView(R.layout.dialog_admin_edit_profile);
