    ...
    private void setupListeners() {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            ...
            if (itemId == R.id.nav_home) {
                // If user clicks home while on maps, go to the main dashboard list view
            ...
            if (itemId == R.id.nav_notices) {
                intent = new Intent(MapsActivity.this, NoticesActivity.class);
            } else if (itemId == R.id.nav_add_post) {
                intent = new Intent(MapsActivity.this, AddPostActivity.class);
            } else if (itemId == R.id.nav_alerts) {
                intent = new Intent(MapsActivity.this, AlertsActivity.class);
        ...
        // "All Issues" button to reset filters
        ...
        db.collection("posts")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        Toast.makeText(MapsActivity.this, "Failed to load issues.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
